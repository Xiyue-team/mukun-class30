        ...
        Object.keys(imgCover).forEach(function(key) {
            imgCover[key].onmouseover = function() {
                setTimeout(function(){
                    ...
                    let imgUrl;
                    if (key == 0) {
                        imgUrl = 'url(\'../home-page/img/home/bei-open.png\')';
                    } else if (key == 1) {
                        imgUrl = 'url(\'../home-page/img/home/jiang-open.png\')';
                    } else if (key == 2) {
                        imgUrl = 'url(\'../home-page/img/home/pi-open.png\')';
                    } else if (key == 3) {
                        imgUrl = 'url(\'../home-page/img/home/fu-open.png\')';
                    } else if (key == 4) {
                        imgUrl = 'url(\'../home-page/img/home/kao-open.png\')';
                    }
